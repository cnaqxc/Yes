...
var normalH="min(620px,78vh)";

var BACKGROUND_URL=
"https://user17929.na.imgto.link/public/2026091/img-1580.avif";

var HOTKEY_STORAGE="oval-hotkey-v4";
...
"color:#fff;overflow:visible;background:transparent;";
...
"@keyframes ovalPulse{0%,100%{transform:scale(1);opacity:.55}50%{transform:scale(1.08);opacity:1}}"+
"@media(max-width:560px){"+
"#oval-root .oval-grid{grid-template-columns:1fr!important}"+
"#oval-root .oval-window{width:96vw!important;height:82vh!important;border-radius:24px!important}"+
"#oval-root .oval-content{padding:13px!important}"+
"}";
...
function makeDraggable(element,handle){
    ...
    function move(e){
        ...
        var maxY=
            Math.max(
                8,
                innerHeight-element.offsetHeight-8
            );
...
function createWindow(title,subtitle,back){
    ...
    css(
        ...
        "background-image:"+
        "linear-gradient(rgba(4,7,15,.22),rgba(4,7,15,.46)),"+
        "url('"+BACKGROUND_URL+"');"+
    ...
    if(back){
        ...
        var bb=makeButton(
            ...
            "margin-right:9px;position:relative;z-index:3;"
        );
    ...
    titleWrap.innerHTML=
        ...
        esc(title||"Oval")+
        "</div>"+
        "<div style='font-size:9px;color:rgba(255,255,255,.45);"+
...
function toggleMinimize(){
    ...
    var body=box.querySelector("#oval-content");
...
function makeCard(icon,title,desc,fn){
    ...
    card.innerHTML=
        ...
        esc(title)+
        "</div>"+
        "<div style='font-size:11px;color:rgba(255,255,255,.46);margin-top:4px'>"+
        esc(desc)+
        "</div>"+
        "</div>"+
...
function goHome(){
    ...
    hero.innerHTML=
        ...
        "<div style='font-size:11px;color:rgba(255,255,255,.48);margin-top:5px'>"+
...
function games(){
    ...
    panel.innerHTML=
        ...
        "🎮 Games"+
        "</div>"+
        "<div style='font-size:11px;color:rgba(255,255,255,.46);margin-top:6px'>"+
        "Original Oval games."+
        "</div>";
...
function embeddedGames(){
    ...
    bar.innerHTML=
        ...
        "left:16px;top:14px;font-weight:800;"+
...
function settings(){
    ...
    keyPanel.innerHTML=
        ...
        "margin-top:5px'>"+
        "Press the keybind to hide/show all of Oval "+
        "and stop sounds while hidden."+
        "</div>";
...
/*
 * Keep this listener separate from
 * per-window cleanup.
 */
